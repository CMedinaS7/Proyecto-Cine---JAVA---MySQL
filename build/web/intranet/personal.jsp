...
<div id=main role=main> <div id=title-bar> <ul id=breadcrumbs> <li><a href="principal.jsp" title=Home><span id=bc-home></span></a></li> <li class=no-hover>Personal</li> </ul> </div> <div class="shadow-bottom shadow-titlebar"></div> <div id=main-content> <div class=container_12> <div class=grid_12> <h1>Personal </h1></div> <div class=grid_12>
  <div class=block-border>
      ...
      <%
				...
				String estado="";	
                    try {
                        ...
                        String cod="";
						String a="select p.IdPersonal,concat(p.Nombres,' ',p.Apellidos) as 'Nombre Completo',p.DNI,p.Telefono,p.Direccion from personal p;";               
						ResultSet rs = stmt.executeQuery(a);
                        out.println("<table id=table-example class=table><thead><tr><th>IdPersonal</th><th>Nombre Completo</th><th>DNI</th><th>Telefono</th><th>Direccion</th></tr></thead><tbody>");
