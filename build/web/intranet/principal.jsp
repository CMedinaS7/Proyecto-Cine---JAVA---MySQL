...
<h3>Logueado como</h3> 
<h2><a class=user-button href="javascript:void(0);">Administrador<span class=arrow-link-down></span></a></h2> <ul class=dropdown-username-menu> 
...
<div class=clearfix></div> </section> <nav id=nav>
  ...
  <div class="alert info"><span class=hide>x</span><strong>Recuerde leer los terminos y condiciones que impone la empresa para poder usar el intranet CINE-MAX de forma apropiada y correcta. Att. El Administrador</strong>.</div> </div> <div class=grid_12> <div class=block-border> <div class=block-content> <ul class=shortcut-list> <li> <a href="reportes.jsp"> <img src="img/icons/packs/crystal/48x48/apps/kedit.png"> Reportes </a> </li> <li> <a href="peliculas.jsp"> <img src="img/icons/packs/onebit/48x48/onebit_131.png"> Peliculas</a></li>
          <li></li> 
          <li> <a href="javascript:void(0);"> <img src="img/icons/packs/onebit/48x48/onebit_18.png" border="0"> Cines </a> </li> <li> <a href="javascript:void(0);"> <img src="img/icons/packs/crystal/48x48/apps/mailreminder.png" border="0"> Mensajes </a> </li> <li> <a href="javascript:void(0);"> <img src="img/icons/packs/crystal/48x48/apps/Volume%20Manager.png"> Graficos </a> </li> <li> <a href="personal.jsp"> <img src="img/icons/packs/onebit/48x48/onebit_19.png" border="0"> Personal </a> </li> <li> <a href="javascript:void(0);" onClick="$('#info-dialog').dialog({ modal: true });">
<img src="img/icons/packs/crystal/48x48/apps/knotes.png"> Privacidad </a> </li> <li> <a href="../logoutpersonal"> <img src="img/icons/packs/crystal/48x48/apps/terminal.png" border="0"> Logout </a> </li> <li> <a href="principal.jsp"> <img src="img/icons/packs/onebit/48x48/onebit_63.png" border="0"> Principal </a> </li> </ul> <div class=clear></div> </div> </div> </div> <div class=grid_4> <div class=block-border> <div class=block-header> <h1>Enviar un Mensaje</h1>
        <span></span> </div> <form id=validate-form class="block-content form" action="#" method=post> <p class=inline-mini-label> <label for=title>Asunto</label> <input type=text name=title class=required> </p> <p class=inline-mini-label> <label for=category>Destino</label> 
        <select name=category id=category>
          <option>Carlos Medina</option>
          <option>Gabriela Alvarez</option>
          <option>Andres Nureña </option>
          <option>Kike Vasquez</option>
          <option>Valeria Bozzio</option>
          <option>Mayra Marquina</option>
        </select> </p> <p class=inline-mini-label> <label for=post>Mensaje</label> 
        <textarea id=post name=post class=required rows=5 cols=40></textarea> </p> </p> <div class=clear></div> <div class=block-actions> <ul class=actions-left> <li><a class="button red" id=reset-validate-form href="javascript:void(0);">Cancelar</a></li> </ul> <ul class=actions-right> <li><input type=submit class=button value="Enviar Mensaje"></li> </ul> </div> </form> </div> </div> <div class=grid_4> <div class=block-border> <div class=block-header> <h1>Peliculas con mayor asistencia</h1><span></span> </div> <div class=block-content> <ul class="block-list with-icon"> <li class=i-16-calendar>Los vengadores</li> <li class=i-16-application>Madagascar 3</li> <li class=i-16-balloon>REC 3</li> <li class=i-16-chart>Hombres de negro 3</li> 
        <li class=i-16-drive>Drive</li> </ul> </div> <div class="block-content dark-bg"> <p>Para ver la lista completa  revise los reportes diarios.</p> </div> </div> </div> <div class=grid_4> <div class=block-border> <div class=block-header> <h1>Informacion Basica</h1><span></span> </div> <div class=block-content> <div class="alert info no-margin top">Muestra el total de los registros almacenados en la Base de Datos.</div> <ul class=overview-list> <li><a href="javascript:void(0);"><span>45</span> Total Peliculas</a></li> <li><a href="javascript:void(0);"><span>50</span> Total Clientes</a></li> <li><a href="javascript:void(0);"><span>80</span>Total Personal</a></li> <li></li> </ul> </div> </div> </div> <div class="clear height-fix"></div> </div></div> </div> <footer id=footer><div class=container_12> <div class=grid_12> <div class="footer-icon align-center"><a class=top href="#top"></a></div> </div> </div></footer> </div> <script>window.jQuery||document.write('<script src="js/libs/jquery-1.6.2.min.js"><\/script>');</script> 
