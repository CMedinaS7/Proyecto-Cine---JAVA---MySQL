...
<%
            ...
            String nombre="",director="",reparto="",duracion="",clasificacion="",tipo="",trailer="",foto="",sinopsis="";
...
<div id=main role=main> <div id=title-bar> <ul id=breadcrumbs> <li><a href="principal.jsp" title=Home><span id=bc-home></span></a></li> <li class=no-hover>Pelicula</li> </ul> </div> <div class="shadow-bottom shadow-titlebar"></div> <div id=main-content> <div class=container_12>
<div class=grid_12>
  <h1>Formulario Peliculas</h1>
  <p>Este formulario permite grabar y modificar los datos de una pelicula.</p>
</div>
<div class=grid_12>
  ...
  <div class=grid_6>
    <div class=block-border>
      <div class=block-header>
        <h1>Grabar Datos de Pelicula</h1>
        <span></span></div>
      <form id=login-form class="block-content form" name="formulario2" action="../moduloPelicula" method=post>
      <div class=_100>
        <p>
            <label for=txtpeli>Nombre de Pelicula:</label>
            <input id=txtpeli name=txtpeli class=required type=text value=""/>
        </p>
      </div>
      <div class=_100>
        <p>
            <label for=txtdir>Director de Pelicula:</label>
            <input id=txtdir name=txtdir class=required type=text value=""/>
        </p>
      </div>
      <div class=_100>
        <p>
            <label for=txtrep>Reparto:</label>
            <textarea class="required" name="txtrep" id="txtrep" cols="45" rows="5"></textarea>
        </p>
      </div>
      <div class=_100>
        <p>
            <label for=txtdur>Duracion:</label>
            <input id=txtdur name=txtdur class="required digits" type=number value=""/>
        </p>
      </div>
          <div class=_50>
            <p>
              <label for=cbocla>Clasificacion:</label>
              <select class="required" name="cbocla" id="cbocla">
                <option value="Mayores 12 años">Mayores 12 años</option>
                <option value="Publico General">Publico General</option>
                <option value="Mayores 14 años">Mayores 14 años</option>
                <option value="Mayores 15 años">Mayores 15 años</option>
                <option value="Mayores 18 años">Mayores 18 años</option>
          ...
          <div class=_50>
            <p>
              <label for=txttip>Tipo:</label>
              <input id=txttip name=txttip class="required" type=text value=""/>
            </p>
          </div>
<div class=_100>
            <p>
              <label for=txttra>Trailer:</label>
              <input id=txttrailer name=txttrailer class="required" type=text value=""/>
            </p>
          </div>
          ...
          <div class=_100>
            <p>
              ...
              <textarea class="required" name="txtsin" id="txtsin" cols="45" rows="5"></textarea>
            </p>
          </div>
          <div class=_100>
            <p>
              <label for=foto>Seleccione foto de pelicula:
        ...
        <div class=block-actions>
          <ul class=actions-left>
            <li><a class="button red" id=reset-validate-form href="peliculas.jsp">Cancelar</a></li>
          </ul>
          <ul class=actions-right>
            <li>
  ...
  <% }
                    ...
                    try {
                        ...
                        String a="select * from pelicula where idpelicula='"+codigo+"';";               
 ...
 <div class=grid_6>
    <div class=block-border>
      <div class=block-header>
        ...
        <span></span></div>
<form id=login-form name="formulario2"  class="block-content form" action="../moduloPelicula" method="post">
      <div class=_100>
        <p><input name=txtcodigo type="hidden" class=required id=txtcodigo value="<%=codigo%>"/>
        
            <label for=txtpeli>Nombre de Pelicula:</label>
            <input id=txtpeli name=txtpeli class=required type=text value="<%=nombre%>"/>
          </p>
      </div>
      <div class=_100>
        <p>
            <label for=txtdir>Director de Pelicula:</label>
            <input id=txtdir name=txtdir class=required type=text value="<%=director%>"/>
          </p>
      </div>
      <div class=_100>
        <p>
            <label for=txtrep>Reparto:</label>
            <textarea name="txtrep" id="txtrep"  cols="45" rows="5"><%=reparto%></textarea>
          </p>
      </div>
      <div class=_100>
        <p>
            <label for=txtdur>Duracion:</label>
            <input id=txtdur name=txtdur class="required digits" type=number value="<%=duracion%>"/>
          </p>
      </div>
          <div class=_50>
            <p>
          ...
          <div class=_50>
            <p>
              <label for=txttip>Tipo:</label>
              <input id=txttip name=txttip class="required" type=text value="<%=tipo%>"/>
            </p>
          </div>
          <div class=_100>
            <p>
              <label for=txttra>Trailer:</label>
              <input id=txttra name=txttra class="required" type=text value="<%=trailer%>"/>
            </p>
          </div>
          ...
          <div class=_100>
            <p>
              <label for=>Sinopsis:</label>
              <textarea name="txtsin" id="txtsin" cols="45" rows="5"><%=sinopsis%></textarea> 
            </p>
          </div>
          <div class=_100>
            <p>
              <label for=foto>Seleccione foto de pelicula:
                <input name="foto" type=file id="foto" class="required" value="<%=foto%>">
              </label>
            </p>
          </div>
          <div class=clear></div>
        <div class=block-actions>
          <ul class=actions-left>
            <li><a class="button red" id=reset-validate-form2 href="peliculas.jsp">Cancelar</a></li>
          </ul>
          <ul class=actions-right>
            <li>
