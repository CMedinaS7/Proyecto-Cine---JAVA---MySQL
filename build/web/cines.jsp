<%-- 
    Document   : cines
    Created on : 14-jun-2012, 16:30:59
          ...
          <br /><br />
		    ...
		    Connection cn;
				    ...
				    String nombre="";
                                    ...
                                    String foto="";
                                    String telefono="";
                                    String a="select IdCine,nombre,direccion,telefono,foto from cine";
            ...
            <div class="pelicula_foto_c" style="width:237px;"><img src="<%=foto%>" width="227" height="170"> </div> 
               	<div class="pelicula_opciones" style="width:350px;">
                <div class="interna_pelicula_opciones">
       			   <h4><%=nombre%></h4><br>
                <span class="sinopsis"><%=direccion%><br><br>
               Teléfono: <%=telefono%>                						</span>
                </div>
                <div class="iconos_link">
                <div class="icos_links2"><span>Ver más</span><a class="red colorTipContainer" href="detalle_cine.jsp?cine=<%=codigo%>"><img src="static/images/ico_info.jpg" width="33" height="31"><span class="colorTip">ver más<span class="pointyTipShadow"></span><span class="pointyTip"></span></span></a></div>
