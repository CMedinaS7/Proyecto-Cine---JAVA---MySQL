<%-- 
    Document   : maxcard
    Created on : 15-jun-2012, 12:31:39
...
<base  />
<title>Max - Card | Multicines CineMax</title>
...
<div id="main_contento">
 ...
 <div class="banners_internos">
        	...
        	<div class="banner2_h2">
                <div class="banner2_h_info"><a href="#"><img src="static/images/banners/banner-sidebar-266x133.jpg" width="266" height="133" /></a></div>
          </div>
          &nbsp;
          <br /><br />
 <div class="banner3_h">
                ...
                <!--<div class="banner3_h_info"><a href="ventas_corporativas/"><img src="corporativo.jpg" width="268" height="133" /></a></div>-->
                    ...
                    <img style="margin-left:-5px;" src="static/images/foto_stard_card.jpg" />
                    <h4><br />Max Card</h4><br />
                    <p>
                    <span class="tx_gris">
Para obtener tu MAX CARD solo tienes que acercarte al módulo de Cine Star Benavides, Aviación, Excelsior, Sur, San Juan, Comas, UNI o Breña y llenar nuestro formulario de nuevo usuario, el costo por adquirir la tarjeta es de s/. 2.00.<br /><br />

Puedes escoger entre los 5 modelos de MAX CARDS<br /><br />

Al terminar de llenar los datos la persona encargada le hará entrega de su tarjeta. La cual es necesaria para poder canjear los puntos que en ella se acumulen.<br /><br />
    
<h4>Beneficios:</h4><br />

Usando tu MAX CARDS acumulas puntos y accedes a un mundo de premios, concursos  y promociones exclusivas.<br /><br />

Además hazte fan de CINE MAX en facebook y se parte de premios exclusivos para ti. <br /><br />
<span class="tx_gris"><a href="http://www.facebook.com/CINE.MAX.IHC" target="_blank"><span class="tx_gris"><h5>www.facebook.com/CINE.MAX.IHC</h5></span></a> </span>
</span></p> 
