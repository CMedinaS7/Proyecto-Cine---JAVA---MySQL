<%-- 
    Document   : concursos.jsp
    Created on : 15-jun-2012, 12:43:14
...
<base  />
<title>Consursos | Multicines CineMax</title>
...
<div id="main_contento">
        ...
        <div id="infoi_der">
        	<div id="infoi_der_info">
           	  <div id="area_info_internas">
               	<h1 class="tituloh1">Consursos</h1>
 ...
 <div id="contenedor_peliculas" style="background-color:#FFF; margin-top:5px;">

   <p>   
   <div class="concurso">
     <table>
       <tr>
         <td valign="top"><img src="static/images/concursos/vengadores.jpg" /></td>
         <td><table>
           <tr>
             <td><h3>CONCURSO LOS VENGADORES</h3>
               Participaron y ganaron:<br />
               <ul>
                 <li>José Vicuña Bravo</li>
                 <li>Luis Alberto Chacón Arana</li>
                 <li>Juana Amelia Quiroga</li>
                 <li>Olga Lidia Yshpilco</li>
                 <li>Freddy Ayala Ríos</li>
               </ul>
               <br />
               Recoger los premios en Cine Max Real Plaza(Av. Benavides 4981 - Surco / Telef:275-4685 anexo:22)<br />
               Los premios podrán recogerse hasta el 28 de junio, de lunes a viernes entre las 10:30 p.m. a 1:30 p.m. y 3:30 p.m. a 5:30pm.<br />
               Los ganadores deberán traer su D.N.I. (original y copia simple) </td>
           </tr>
           <tr>
             <td></td>
           </tr>
   ...
   <div class="concurso">
     <table>
       <tr>
         <td valign="top"><img src="static/images/concursos/piratas.jpg" /></td>
         <td><table>
           <tr>
             <td><h3>CONCURSO Piratas: Una Loca Aventura</h3>
               Participaron y ganaron:<br />
               <ul>
                 <li>Katia Izquierdo</li>
                 <li>José Luis Chávez Arana</li>
                 <li>Killa Yajaira Chávez Car</li>
                 <li>Leonardo Alburqueque</li>
               </ul>
               <br />
               Recoger los premios en Cine Max Centro (Av. Benavides 4981 - Surco / Telef:275-4685 anexo:22)<br />
               Los premios podrán recogerse hasta el 25 de julio, de lunes a viernes entre las 10:30 p.m. a 1:30 p.m. y 3:30 p.m. a 5:30pm.<br />
               Los ganadores deberán traer su D.N.I. (original y copia simple) </td>
           </tr>
           <tr>
             <td></td>
   ...
   <br />
   <center>
     <div id="cargando" style="display:none; color:#000; text-align:center;"><br />
