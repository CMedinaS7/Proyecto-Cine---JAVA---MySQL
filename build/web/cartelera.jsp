<%-- 
    Document   : cartelera
    Created on : 14-jun-2012, 15:56:59
          ...
          <br /><br />
		    ...
		    Connection cn;
				    ...
				    String nombre="";
                                    ...
                                    String foto="";
                                    String sinopsis="";
                                    String a="select IdPelicula,nombre,trailer,substring(sinopsis,1,350),foto from pelicula";
				...
				sinopsis=String.valueOf(rs.getString(4));
				foto=String.valueOf(rs.getString(5));
					%>               
                           ...
                           <div class="caja_pelicula">
            <div class="pelicula_foto_c"><img src="<%=foto%>" width="116" height="170" /> </div> 
               	<div class="pelicula_opciones">
                <div class="interna_pelicula_opciones" style="margin-left:10px;">
       			   <h4><%=nombre%></h4><br />
                <span class="sinopsis"><%=sinopsis%> ....</span>
                </div>
                  
                <div class="iconos_link">
                  
                                         <div class="icos_links2">
                                        <span>Ver Trailer</span>  <a class="red" title="ver trailer" href="<%=trailer%>" target="_blank">
                                         <img src="static/images/ico_video.jpg" width="33" height="31" style="border:0;" />
                                         </a></div>
                    

 
                   <div class="icos_links2"><span>Ver más</span> <a class="red" title="ver más" href="detalle_pelicula.jsp?pelicula=<%=codigo%>"><img src="static/images/ico_info.jpg" width="33" height="31" /></a></div>
