<%-- 
    Document   : horario_pelicula
    Created on : 14-jun-2012, 21:32:43
...
<br /><div class="clearbox"></div>
		    ...
		    Connection cn;
                    ...
                    String cod=request.getParameter("cines_select");
					int c=1;
                    ...
                    try{
						...
						String a="SELECT PELICULA.Nombre, PELICULA.Sinopsis, PELICULA.Trailer, PELICULA.Foto, CINE.Nombre AS Expr1, HORARIO.Dia, HORARIO.Hora FROM  HORARIO INNER JOIN CINE ON HORARIO.IdCine = CINE.IdCine INNER JOIN PELICULA ON HORARIO.IdPelicula = PELICULA.IdPelicula where PELICULA.IdPelicula='"+ cod +"';";

                                                                                                           
						ResultSet rs = stmt.executeQuery(a);
                        while (rs.next()) {
				pelicula=String.valueOf(rs.getString(1));
                     		sinopsis=String.valueOf(rs.getString(2));
				trailer=String.valueOf(rs.getString(3));
                     		foto=String.valueOf(rs.getString(4));
				cine=String.valueOf(rs.getString(5));
                     		dia=String.valueOf(rs.getString(6));
...
<div class="detalles">
                     <table width="331" border="0" cellspacing="5" cellpadding="0" bgcolor="#CCCCCC">
<tr>
    <td width="105" align="left" valign="top" class="titu_simple_rojo">CINE</td>
    <td width="15" align="left" valign="top">&nbsp;</td>
    <td width="116" align="left" valign="top" class="tx_gris"><span class="titu_simple_rojo">DIA</span></td>
    <td width="70" align="left" valign="top" class="tx_gris"><span class="titu_simple_rojo">HORA</span></td>
  </tr>
  <tr>
    <td width="105" align="left" valign="top" class="titu_simple_rojo"><span class="tx_gris"><%=cine%></span></td>
    <td width="15" align="left" valign="top">&nbsp;</td>
    <td width="116" align="left" valign="top" class="tx_gris"><%=dia%></td>
    <td width="70" align="left" valign="top" class="tx_gris"><%=hora%></td>
  </tr>
                <%c=0;}else{%>
