...
<%
            ...
            String nombre="",des="",direccion="",telefono="",email="",cargo="",activo="0",foto="",usuario="",clave="";
...
<div id=main role=main> <div id=title-bar> <ul id=breadcrumbs> <li><a href="principal.jsp" title=Home><span id=bc-home></span></a></li> <li class=no-hover>Cine</li> </ul> </div> <div class="shadow-bottom shadow-titlebar"></div> <div id=main-content> <div class=container_12><div class=grid_12>
  <div class=grid_12>
    <h1>Formulario Cine</h1>
    <p>Este formulario permite grabar y modificar los datos de un Cine.</p>
  </div>
                <%if(codigo==null){%>
  ...
  <div class=grid_6>
    <div class=block-border>
      <div class=block-header>
        <h1>Grabar Datos de Cine</h1>
        <span></span></div>
      <form id=login-form class="block-content form" action="../moduloCine" method=post>
        <div class=_100>
          <p>
            <label for=txtnombre>Nombre:</label>
            <input id=txtnombre name=txtnombre class=required type=text value=""/>
          </p>
          </div>
          <div class=_100>
          <p>
          ...
          <p>
            ...
            <input id=txtdes name=txtdes type=text value=""/>
          </p>
        </div>
        <div class=_100>
            <p>
              <label for=foto>Seleccione foto de Cine:
        ...
        <div class=block-actions>
          <ul class=actions-left>
            <li><a class="button red" id=reset-validate-form href="cines.jsp">Cancelar</a></li>
          </ul>
          <ul class=actions-right>
            <li>
            ...
            <%
                    ...
                    try {
                        ...
                        String a="select * from cine where Idcine='"+codigo+"';";               
                        ResultSet rs = stmt.executeQuery(a);
                        while (rs.next()) {

	    		nombre=String.valueOf(rs.getString(2));
                        direccion=String.valueOf(rs.getString(3));
                        telefono=String.valueOf(rs.getString(4));
                        foto=String.valueOf(rs.getString(5));
...
%>
  <div class=grid_6>
    <div class=block-border>
      <div class=block-header>
        <h1>Actualizar Datos de Cine</h1>
        <span></span></div>
      <form id=login-form  class="block-content form" action="../moduloCine" method=post>
         <div class=_100>
          <p>
            <label for=txtnombre>Nombre:</label>
            <input id=txtcodigo name=txtcodigo class=required type="hidden" value="<%=codigo%>"/>
            <input id=txtnombre name=txtnombre class=required type=text value="<%=nombre%>"/>
          </p>
          </div>
          <div class=_100>
          <p>
          ...
          <p>
            <label for=txtdes>Descripcion:</label>
            <input id=txtdes name=txtdes type=text value="<%=des%>"/>
          </p>
        </div>
        <div class=_100>
            <p>
        ...
        <div class=block-actions>
          <ul class=actions-left>
            <li><a class="button red" id=reset-validate-form2 href="cines.jsp">Cancelar</a></li>
          </ul>
          <ul class=actions-right>
            <li>
