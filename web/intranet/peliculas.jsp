...
<div id=main role=main> <div id=title-bar> <ul id=breadcrumbs> <li><a href="principal.jsp" title=Home><span id=bc-home></span></a></li> <li class=no-hover>Peliculas</li> </ul> </div> <div class="shadow-bottom shadow-titlebar"></div> <div id=main-content> <div class=container_12> <div class=grid_12> <h1> Peliculas </h1></div> <div class=grid_12>
  <div class=block-border>
    <div class=block-header>
      <h1>Lista de todas las peiculas</h1>
      <span></span></div>
    <div class=block-content>
    <div class="alert note no-margin top">Nota: En esta pagina se muestran todas las peliculas que se encuentran registradas en la base de datos.</div>
    <%if("0".equals(resp)){%>
      <div class="alert info no-margin top"><span class=hide>x</span>Se ha añadido un nuevo registro en la tabla pelicula de forma correcta!!!.</div>
      <%}else if("1".equals(resp)){%>
      <div class="alert info no-margin top"><span class=hide>x</span>Se ha modificado los datos de un registro en la tabla pelicula de forma correcta!!!.</div>
      ...
      <%
                    ...
                    try {
						...
						String a="select idpelicula,nombre,director,duracion,clasificacion,tipo  from pelicula;";;               
						ResultSet rs = stmt.executeQuery(a);
                        out.println("<table id=table-example class=table><thead><tr><th>Codigo</th><th>Nombre</th><th>Director</th><th>Duracion</th><th>Clasificacion</th><th>Tipo</th></tr></thead><tbody>");
                        while (rs.next()) {
							cod=String.valueOf(rs.getString(1));
			    					out.println("<tr class=gradeA>"); 
						
							out.println("<td><a href=peliculas1.jsp?cod="+cod+">"+rs.getString(1)+"</a></td>");
                       		out.println("<td>"+rs.getString(2)+"</td>");
							out.println("<td>"+rs.getString(3)+"</td>");
							out.println("<td>"+rs.getString(4)+" Minutos</td>");
