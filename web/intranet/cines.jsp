...
<div id=main role=main> <div id=title-bar> <ul id=breadcrumbs> <li><a href="principal.jsp" title=Home><span id=bc-home></span></a></li> <li class=no-hover>Cine</li> </ul> </div> <div class="shadow-bottom shadow-titlebar"></div> <div id=main-content> <div class=container_12> <div class=grid_12> <h1>Cines </h1></div> <div class=grid_12>
  <div class=block-border>
    ...
    <div class=block-content>
      <div class="alert note no-margin top">Nota: Esta tabla muestra todos los cines disponibles a nivel nacional.</div>
        <%if("0".equals(resp)){%>
      ...
      <div class="alert info no-margin top"><span class=hide>x</span>Información: Se ha modificado los datos de un registro en la tabla cine de forma correcta!!!.</div>
      ...
      <%
				...
				String estado="";	
                    try {
                        ...
                        String cod="";
						String a="select * from cine c;";               
						ResultSet rs = stmt.executeQuery(a);
                        out.println("<table id=table-example class=table><thead><tr><th>IdCine</th><th>Nombre</th><th>Direccion</th><th>Telefono</th><th>Descripcion</th></tr></thead><tbody>");
						
                        while (rs.next()) {

	    					out.println("<tr class=gradeA>"); 
                            cod=String.valueOf(rs.getString(1));
							out.println("<td><a href=cines1.jsp?cod="+cod+">"+rs.getString(1)+"</a></td>");
