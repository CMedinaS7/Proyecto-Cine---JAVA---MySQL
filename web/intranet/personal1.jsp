...
<%
            ...
            String nombres="",apellidos="",dni="",direccion="",telefono="",email="",cargo="",activo="0",foto="",usuario="",clave="";
      ...
      <form id=login-form class="block-content form" action="../moduloPersonal" method=post>
        ...
        <div class=_50>
            <p>
              ...
              <input name="txtusuario" class=required type=text id=txtusuario value="" />
            </p>
          </div>
          <div class=_50>
            <p>
          ...
          <div class=_100>
            <p>
              <label for=foto>Seleccione foto de persona:
          ...
          <ul class=actions-right>
            ...
            <%
                    ...
                    try {
                        ...
                        String a="select * from personal where IdPersonal='"+codigo+"';";               
                        ResultSet rs = stmt.executeQuery(a);
                        while (rs.next()) {

	    		        nombres=String.valueOf(rs.getString(2));
                        apellidos=String.valueOf(rs.getString(3));
                        direccion=String.valueOf(rs.getString(4));
                        telefono=String.valueOf(rs.getString(5));
                        dni=String.valueOf(rs.getString(6));
                        usuario=String.valueOf(rs.getString(7));
                        clave=String.valueOf(rs.getString(8));
                        foto=String.valueOf(rs.getString(9));
    ...
    <div class=block-border>
      ...
      <form id=login-form  class="block-content form" action="../moduloPersonal" method=post>
        ...
        <div class=_50>
            <p>
              <label for=txtusuario>Usuario:</label>
              <input name="txtusuario" class=required type=text id=txtusuario value="<%=usuario%>" />
            </p>
          </div>
          <div class=_50>
            <p>
