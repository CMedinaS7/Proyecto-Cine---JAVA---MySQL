<%-- 
    Document   : detalle_cine
    Created on : 14-jun-2012, 17:31:42
        ...
        <div id="infoi_der">
        	<div id="infoi_der_info">
            	<div id="area_info_internas">
                	<h1 class="tituloh1">Nuestros Cines</h1>
    <div class="addthis_toolbox addthis_default_style" style="float:right; background-color:#FFF; width:380px; height:25px; padding-top:5px; padding-left:15px; margin-right:310px; ">
 ...
 <div class="banners_internos">
          ...
          <br /><br />
		    ...
		    Connection cn;
                    ...
                    String codigo=request.getParameter("cine");
                    try{
			 	    ...
			 	    String cine="";
                                    ...
                                    String filtro="";
                                    int c=1;
                                    String a="SELECT dbo.CINE.Nombre, dbo.CINE.Direccion, dbo.CINE.Telefono,dbo.CINE.foto, dbo.PELICULA.Nombre AS Expr1, dbo.PELICULA.IdPelicula, dbo.HORARIO.Hora FROM dbo.CINE INNER JOIN dbo.HORARIO ON dbo.CINE.IdCine = dbo.HORARIO.IdCine INNER JOIN dbo.PELICULA ON dbo.HORARIO.IdPelicula = dbo.PELICULA.IdPelicula where dbo.HORARIO.Dia=Convert(Char(10), GETDATE() , 102) AND dbo.CINE.IdCine='" + codigo + "'";

                                                                                                           
			ResultSet rs = stmt.executeQuery(a);
                        while (rs.next()) {
				cine=String.valueOf(rs.getString(1));			
				direccion=String.valueOf(rs.getString(2));
                                telefono=String.valueOf(rs.getString(3));
				foto=String.valueOf(rs.getString(4));
				pelicula=String.valueOf(rs.getString(5));
                                filtro=String.valueOf(rs.getString(6));
                                hora=String.valueOf(rs.getString(7)) + "  /  ";
                                if (c==1){                    
  ...
  <div id="contenedor_peliculas">
                ...
                <div id="contenedor_peliculas" style="background-color:#FFF; margin-top:5px; padding:3px 3px 8px 3px; width:637px;">
                   <img src="<%=foto%>">
                    <div style="float:right;  width:400px; height:auto;">
                    <span class="tx_gris">
 <span class="titlex">CineMax</span> <span class="titley"><%=cine%></span>  
                     
                   <p><%=direccion%></p>                   <p>Teléfono: <%=telefono%></p>                                        
...
<div class="precioscine">
  <table class="odd" width="100%" height="100%">
  <tbody><tr><td>Lunes, Martes y Miércoles </td><td>S/. 4.50</td></tr><tr style="background-color: rgb(255, 253, 221); "><td>Jueves y Viernes </td><td>S/. 6.50</td></tr><tr><td>Sábado, Domingo y Feriados </td><td>S/. 8.00</td></tr><tr style="background-color: rgb(255, 253, 221); "><td>Adulto mayor y niños hasta 10 años </td><td>S/. 6.00</td></tr><tr><td>3D - Lunes, Martes y Miércoles </td><td>S/. 10.00</td></tr><tr style="background-color: rgb(255, 253, 221); "><td>3D - Jueves, Viernes, Sábado, Domingo y Feriados </td><td>S/. 15.00</td></tr><tr><td>3D - Adulto mayor y niños hasta 10 años </td><td>S/. 12.00</td></tr>   </tbody></table>
   </div>
  
</span> 
  </span>  
  </div> <div style="clear:both;"></div>
  <div class="programacion_">
  <table width="630">	
  <tbody><tr><th width="50%">Películas</th><th>Horarios</th><!--<th>Salas</th>--></tr>
               
  <tr>
      <td>
          <a href="detalle_pelicula?pelicula=<%=filtro%>" alt="Ver Descripción"><%=pelicula%> </a>
      </td>
      <td>
          <%=hora%>
      </td>
  ...
  <tr>
   ...
   <br>
      <img src="static/images/cines/juegos_sur.jpg"> <span class="tx_gris" style="float:right; width:400px;">Precios de los juegos:  S/1.00 en todos los Cine Star. <br>
Horario de atención de juegos es de 2:00 pm a hasta las 10:30 pm.
<br><br>Visitános y diviértete con nosotros.<br><br><b>CINE-MAX</b>, siempre pensando en tí.</span>
       <br>  
