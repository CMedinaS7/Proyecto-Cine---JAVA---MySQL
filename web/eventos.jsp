<%-- 
    Document   : eventos
    Created on : 15-jun-2012, 13:08:04
...
<base  />
<title>Eventos | Multicines CineMax</title>
...
<div id="main_contento">
 ...
 <div id="contenedor_peliculas" style="background-color:#FFF; margin-top:5px;">
   <p>
   <div class="concurso"> <img src="static/images/eventos/kung_fu_panda.jpg" height="372" width="635" /><br />
     <br />
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <h2>El muñeco Po de KUN FU PANDA estará en CineMax !El tour se inicia hoy!</h2>
     <br />
     &nbsp;&nbsp;Estará en:<br />
     &nbsp;&nbsp;Real Plaza: Miércoles 01 de julio de 6 a 8pm<br />
     &nbsp;&nbsp;Centro : Jueves 29 de julio de 3 a 5pm (dia de estreno)<br />
     &nbsp;&nbsp;<br />
   </div>
   <!--           -->
   </p>
